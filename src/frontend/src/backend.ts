...
export class Backend implements backendInterface {
    ...
    async rescheduleAppointment(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitAppointment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateAppointmentStatus(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
